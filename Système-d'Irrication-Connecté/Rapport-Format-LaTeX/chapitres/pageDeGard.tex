...
{\includegraphics[scale =0.4 ]{chapitres/images/anrt.jpg}
	...
	\underline{\bf\Large AGRICULTURE INTELLIGENTE }
	\vglue5mm
	\vspace{2cm}
	\begin{center}
		...
		\vskip3mm
		\titlebox{%  
		\textcolor{cyan}{RÉALISATION D'UN SYSTÈME } \\ \textcolor{cyan}{D'IRRIGATION } \\ \textcolor{cyan}{CONNECTÉ}
		}
	\end{center}
	\vglue5mm
	\vskip5mm
